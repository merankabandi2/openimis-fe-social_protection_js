...
// Searcher-column contribution keys consumed by fe-core's <Searcher> via the
// `columnsContributionKey` prop (feature/searcher-column-contributions branch).
// Downstream modules register {header, formatter} contributions against these.
export const BENEFIT_PLAN_BENEFICIARIES_SEARCHER_COLUMNS_CONTRIBUTION_KEY =
  'socialProtection.BenefitPlanBeneficiariesSearcher.columns';
export const BENEFIT_PLAN_GROUP_BENEFICIARIES_SEARCHER_COLUMNS_CONTRIBUTION_KEY =
