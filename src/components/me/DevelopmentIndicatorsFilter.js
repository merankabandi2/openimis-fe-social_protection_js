...
function DevelopmentIndicatorsFilter({
  ...
  return (
    <div>
      <PublishedComponent
        ...
        label={formatMessage('DevelopmentIndicatorsFilter.name')}
      />
      <PublishedComponent
        pubRef="core.StringInput"
        value={filters.section}
        onChange={(value) => onChangeFilters([{ id: 'section', value }])}
        label={formatMessage('DevelopmentIndicatorsFilter.section')}
      />
    </div>
  );
}

export default DevelopmentIndicatorsFilter;
